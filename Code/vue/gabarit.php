...
<div id="wrapper">
    ...
    <script type="text/javascript" src="contenu/js/GraphM.min.js"></script>
    <script type="text/javascript" src="contenu/js/GraphM-demo.js"></script>

    <script type="text/javascript" src="contenu/js/GraphC.min.js"></script>
    <script type="text/javascript" src="contenu/js/GraphC-demo.js"></script>
