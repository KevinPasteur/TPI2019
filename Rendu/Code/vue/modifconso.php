                ...
                foreach ($result as $consommable) : ?>
                    ...
                    <div class="form-group">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control form-control-user col-lg-3" value="<?= $consommable['nb_exemp']; ?>"  min="1" name="nb_exemp" placeholder="Nombre d'exemplaire" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="form-group">
                            <span> <b>Prix :</b></span>
                            <input type="number" step="any" class="form-control form-control-user col-lg-3" value="<?= $consommable['prix']; ?>" min="1" name="prix" placeholder="Prix"  required>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="form-group">
                            <span> <b>Limite inférieure :</b></span>
                            <input type="number" class="form-control form-control-user col-lg-3" value="<?= $consommable['limite_inf']; ?>" min="1" name="limite_inf" placeholder="Limite inférieure"  required>
                        </div>
                    </div>
                    <hr>
                    <div class="form-group">
