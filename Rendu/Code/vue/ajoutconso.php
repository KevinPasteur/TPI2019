                ...
                <form role="form" method="POST"  action="index.php?action=ajoutconso" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control form-control-user col-lg-3"  name="nb_exemp"  min="1" placeholder="Nombre d'exemplaire" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="form-group">
                            <span> <b>Prix :</b></span>
                            <input type="number" step="any" min="1" class="form-control form-control-user col-lg-3" name="prix" placeholder="Prix"  required>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="form-group">
                            <span> <b>Limite inférieure :</b></span>
                            <input type="number" class="form-control form-control-user col-lg-3" name="limite_inf" min="1" placeholder="Limite inférieure"  required>
                        </div>
                    </div>
                    <hr>
                    <div class="form-group">
